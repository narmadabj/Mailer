<?php 
	...
	else
	{
		...
		if($redirect_to=='')
			echo '<script type="text/javascript">window.location = "'.get_app_path().'/login";</script>';
		else
			echo '<script type="text/javascript">window.location = "'.get_app_path().'/login?redirect='.$redirect_to.'";</script>';
		exit;
	}
?>